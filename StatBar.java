 ...
 * 
 * @author Ahrenn Sivananthan, Tyler Zhang
 * @version Oct 2014
 */
public class StatBar extends DisplayBars
{
    ...
    { 
        ...
        fg.drawImage(new GreenfootImage("" + myWorld.getTotalZombieSpawn(), 18, Color.WHITE, null), 260, 131);
